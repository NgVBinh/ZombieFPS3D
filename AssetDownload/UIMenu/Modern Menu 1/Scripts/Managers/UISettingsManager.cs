...
namespace SlimUI.ModernMenu{
	public class UISettingsManager : MonoBehaviour {
		...
		public void  Start (){
			...
			// check slider values
			musicSlider.GetComponent<Slider>().value = PlayerPrefs.GetFloat("MusicBGVolume");
		...
		public void MusicSlider (){
			PlayerPrefs.SetFloat("MusicBGVolume", sliderValue);
			PlayerPrefs.SetFloat("MusicBGVolume", musicSlider.GetComponent<Slider>().value);
		}
